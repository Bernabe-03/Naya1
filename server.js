...
//   }
// })();
// const getManagerInbox = async (req, res) => {
//   try {
...
// app.use('/api/manager', managerProtect);

// // Ensuite, définissez les routes manager
// app.get('/api/manager/inbox', getManagerInbox);
// app.post('/api/manager/inbox', addToManagerInbox);
// app.get('/api/manager/orders/pending', getPendingOrders);
// app.patch('/api/manager/orders/:id/assign-coursier', assignCoursier);
// app.patch('/api/manager/orders/:id/validate', validateOrder);
// app.patch('/api/manager/orders/:id/cancel', cancelOrder);
// app.get('/api/manager/trash', getTrash);
// app.patch('/api/manager/trash/:id/restore', restoreFromTrash);
// app.delete('/api/manager/trash', emptyTrash);
// app.post('/api/manager/move-to-trash', moveToTrash);

// // Routes coursiers
// app.get('/api/manager/coursiers', getCoursiers);
// app.post('/api/manager/coursiers', createCoursier);
// app.put('/api/manager/coursiers/:id', updateCoursier);
// app.patch('/api/manager/coursiers/:id/status', updateCoursierStatus);
// app.delete('/api/manager/coursiers/:id', deleteCoursier);
...
// // Routes manager avec protection
// app.get('/api/manager/inbox', managerProtect, getManagerInbox);
// app.post('/api/manager/inbox', managerProtect, addToManagerInbox);
// app.get('/api/manager/orders/pending', managerProtect, getPendingOrders);
// app.patch('/api/manager/orders/:id/assign-coursier', managerProtect, assignCoursier);
// app.patch('/api/manager/orders/:id/validate', managerProtect, validateOrder);
// app.patch('/api/manager/orders/:id/cancel', managerProtect, cancelOrder);
// app.get('/api/manager/trash', managerProtect, getTrash);
// app.patch('/api/manager/trash/:id/restore', managerProtect, restoreFromTrash);
// app.delete('/api/manager/trash', managerProtect, emptyTrash);
// app.post('/api/manager/move-to-trash', managerProtect, moveToTrash);

// // Routes coursiers
// app.get('/api/manager/coursiers', managerProtect, getCoursiers);
// app.post('/api/manager/coursiers', managerProtect, createCoursier);
// app.put('/api/manager/coursiers/:id', managerProtect, updateCoursier);
// app.patch('/api/manager/coursiers/:id/status', managerProtect, updateCoursierStatus);
// app.delete('/api/manager/coursiers/:id', managerProtect, deleteCoursier);
