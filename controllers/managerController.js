...
    
    // CORRECTION: Renvoyer directement le tableau de coursiers ou l'objet enveloppé
    // Pour assurer que le frontend reçoit un tableau (si il ne lit pas la propriété .data)
    // On conserve ici la structure enveloppée mais on s'assure que le champ data est présent.
    // L'idéal serait de renvoyer res.json(coursiers); si toutes les fonctions utilitaires
    // de l'API le permettent.
    // ****************************************************************************
